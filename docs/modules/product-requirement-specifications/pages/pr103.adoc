...
. Wireless connection is established to the range of 30 ft (9 m) from the device.
...
.Ribhu Block Diagram
image::{imagesdir}/../../images/ribhu_block_dgm.png[]


.Ribhu Functional Block Diagram
image::{imagesdir}/../../images/ribhu_functional_dgm.png[]
...
==== Tare
For the Ribhu based weighing scale, *_Subtractive Tare_* is considered.
...
.Accurcay Class
include::pr103.adoc[tag=pr100003-accuracy-chk]

.Tare and Zero Setting
include::pr103.adoc[tag=pr100003-tare-zero]

.Access to Configurations
include::pr103.adoc[tag=pr100003-config-access]

.Access to Calibration
include::pr103.adoc[tag=pr100003-calibration-access]

.Communications
include::pr103.adoc[tag=pr100003-communications]

.Serial Numbers
include::pr103.adoc[tag=pr100003-device-sn]
